document.addEventListener("DOMContentLoaded", () => {
    ...
    createCardAnimation("card7", "grid7");
    createCardAnimation("card8", "grid8", true); // 마지막 카드는 사라지지 않음

    // Scroll-down 버튼: card7에 도달하면 사라지고 다시 위로 올라가면 나타남
    ...
    // TOP 버튼: card7에 도달하면 나타나고 클릭 시 맨 위로 이동
